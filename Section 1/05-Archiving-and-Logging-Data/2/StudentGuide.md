...
Test that the script works as expected by inspecting your `~/Downloads` and `~/Documents` directories.
...
One of the most popular tools used by attackers today is called `Netcat` or `nc` for short. 
