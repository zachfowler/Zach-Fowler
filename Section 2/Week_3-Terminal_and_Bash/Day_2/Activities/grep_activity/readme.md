...
**Instructions:**
 ...
 Using only the command line, continue to complete the following tasks in the `student_day2/finding_your_way` folder in your Ubuntu VM:
